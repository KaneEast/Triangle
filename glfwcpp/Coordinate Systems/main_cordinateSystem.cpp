...
int main()
{
    ...
    // ------------------------------------
    Shader_s ourShader("6.1.coordinate_systems.vs", "6.1.coordinate_systems.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            float angle = 20.0f * i;
            model = glm::rotate(model, angle + (float)glfwGetTime()*40, glm::vec3(1.0f, 0.3f, 0.5f));
