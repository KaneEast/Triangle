...
int main()
{
    ...
    // -------------------------
    std::string verextCode = readFileToCstr("modelload.vs");
    std::string fragCode = readFileToCstr("modelload.fs");
    Shader ourShader;
    ourShader.Compile(verextCode.c_str(), fragCode.c_str());

    // load models
    // -----------
    Model ourModel("objs/nanosuit/nanosuit.obj");
