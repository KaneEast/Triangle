...
int main()
{
    ...
    // ------------------------------------
    Shader_s ourShader("5.1.transform.vs", "5.1.transform.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        transform = glm::rotate(transform, (float)glfwGetTime()*40, glm::vec3(1.0f, 2.0f, 1.0f));
